...
var FLAT_STROKE = (shade) => ({
  red: oc.red[shade],
  orange: oc.orange[shade],
  yellow: oc.yellow[shade],
  lime: oc.lime[shade],
  green: oc.green[shade],
  teal: oc.teal[shade],
  cyan: oc.cyan[shade],
  blue: oc.blue[shade],
  indigo: oc.indigo[shade],
  violet: oc.violet[shade],
  grape: oc.grape[shade],
  pink: oc.pink[shade]
});
var FLAT_FILL = (shade) => ({
  red: oc.red[shade],
...
var parseFileContents = async (blob) => {
  ...
  if (blob.type === MIME_TYPES.png) {
    try {
      return await (await import("./data/image-HM2ZO2UZ.js")).decodePngMetadata(blob);
    } catch (error) {
...
//# sourceMappingURL=chunk-433JNWA2.js.map
